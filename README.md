...
<a href="https://imran-resume.netlify.app/">CLICKING HERE</a>
...
```git clone https://github.com/mechmdim4an/imran_resume_portfolio_with_React.git```
...
Thanks to Sunny, the PAPA React js for his support to developers 
